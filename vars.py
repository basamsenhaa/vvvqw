...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8266549619:AAG2z0IYutTuFlEAc5nUozT9x0TXv-KrUHY")
...
OWNER_ID = int(os.environ.get("OWNER_ID", "6749667797"))
ADMINS = [int(x) for x in os.environ.get("ADMINS", "6749667797").split()]  # Default to owner ID
